...
import tk.yallandev.saintmc.gladiator.challenge.shadow.ShadowChallenge;
...
public class PlayerListener {
	...
	public PlayerListener() {
		...
		normalChallenge = new ActionItemStack(new ItemBuilder().type(Material.IRON_FENCE).name("§aGladiator Normal").build(),
				new Interact(InteractType.PLAYER) {
...
//	}
	...
	@EventHandler
	public void onPlayerWarpJoin(PlayerJoinEvent event) {
		Player player = event.getPlayer();
	...
	@EventHandler
	public void onPlayerWarpJoin(PlayerQuitEvent event) {
		Player player = event.getPlayer();
