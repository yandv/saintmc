...
public class NMS {
	...
	private static final String craft_maprenderer = "org.bukkit.craftbukkit." + server_version
			+ ".map.CraftMapRenderer";
	...
	private static final String persistant_collection = "net.minecraft.server." + server_version
