...
public class GuildConfiguration {
	...
	public GuildConfiguration(long guildId) {
		try {
			JsonElement json = CommonConst.DEFAULT_WEB.doRequest(CommonConst.DISCORD_URL + "?discordId=" + guildId,
					Method.GET);
	...
	public boolean hasChannel(String string) {
		return chatMap != null && chatMap.containsKey(string);
	}
