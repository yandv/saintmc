...
public class MongoDatabase implements Database {
	...
	public MongoDatabase(String hostName, String userName, String passWord, String dataBase, int port) {
	...
	public MongoDatabase(String hostName, String userName, String passWord, String dataBase) {
	...
	public static <T> void main(String[] args) {
		MongoDatabase mongo;
		(mongo = new MongoDatabase("mongodb+srv://root:kD2TqMzSyP78Keuk@cluster0-rcg3s.gcp.mongodb.net/test?retryWrites=true&w=majority"))
						.connect();
