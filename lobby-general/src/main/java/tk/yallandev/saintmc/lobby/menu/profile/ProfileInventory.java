...
public class ProfileInventory {
	...
	public ProfileInventory(Player player) {
		...
		inv.setItem(13,
				builder.type(Material.SKULL_ITEM).durability(3).skin(player.getName())
		...
		inv.setItem(29,
				builder.type(Material.PAPER).name("§aVer estatísticas").lore(
		...
		inv.setItem(30, builder.type(Material.ITEM_FRAME).name("§aSua skin")
